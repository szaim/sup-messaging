...
describe('Message endpoints', function() {
    ...
    beforeEach(function(done) {
        ...
        mongoose.connection.db.dropDatabase(function(err, res) {
            ...
            this.alice = {
                username: 'alice',
                _id: '57a8164ab5b5e9f7c315d031'
            };

            this.bob = {
                username: 'bob',
                _id: '57a816bab5b5e9f7c315d033'
            };

            this.chuck = {
                username: 'chuck',
                _id: '57a816bab5b5e9f7c315d035'
            };
    ...
    describe('/messages', function() {
        ...
        describe('POST', function() {
            ...
            it('should reject messages from non-existent users', function() {
                var message = {
                    from: 'DDDDDDDDDDDDDDDDDDDDDDDDdddddddddffljdkfdsjlfdjdf',
                    to: this.bob._id,
                    text: 'Hi Bob'
                };
                var spy = makeSpy();
            ...
            it('should reject messages to non-existent users', function() {
                var message = {
                    from: this.alice._id,
                    to: 'ddddddddddddddddddddddddffffffffffffffffffff',
                    text: 'Hi Dan'
                };
                var spy = makeSpy();
